...
export const REFRESH_COUPON_LIST_REQUEST = 'REFRESH_COUPON_LIST_REQUEST'
export const REFRESH_USER_COUPON_LIST_REQUEST = 'REFRESH_USER_COUPON_LIST_REQUEST'
export const RECEIPT_ORDER_REQUEST = 'RECEIPT_ORDER_REQUEST'
export const SET_COUPONS_QUERY = 'SET_COUPONS_QUERY'
export const SET_USER_COUPONS_QUERY = 'SET_USER_COUPONS_QUERY'
