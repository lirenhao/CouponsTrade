...
export function* watchRefreshOrderList() {
    yield takeEvery(Const.REFRESH_ORDER_LIST_REQUEST, Async.fetchRefreshOrderList)
}
...
export function* watchCancelOrder() {
    yield takeEvery(Const.CANCEL_ORDER_REQUEST, Async.fetchCancelOrder)
}

export function* watchReceiptOrder() {
    yield takeEvery(Const.RECEIPT_ORDER_REQUEST, Async.fetchReceiptOrder)
}
...
export function* watchRefreshCouponListRequest(){
